...
public class Calculator {
    ...
    public void start() {
        ...
        var firstValue = scanner.next(expression.getARABIC() + expression.getOR() + expression.getROMAN());
        ...
        IntFunction<String> toStringArabicNumbers;
        if (isRoman) toStringArabicNumbers = Converter::arabicToRomanNumbers;
        else toStringArabicNumbers = Integer::toString;
